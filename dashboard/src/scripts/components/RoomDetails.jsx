...
import RoomMessages from './rooms/RoomMessages.jsx'
import RoomHistory from "./rooms/RoomHistory.jsx";
import RoomBots from "./rooms/RoomBots.jsx";
import RoomPlayers from "./rooms/RoomPlayers.jsx";
...
export class RoomDetails extends Component {
	...
	render(){
		...
		const showBots = ()=>{
			if(tab === "bots"){
				return(<RoomBots roomName={roomName} />)
			}
