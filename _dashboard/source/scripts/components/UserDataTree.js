...
export class UserDataTree extends Component {
	...
	render(){
		...
		function cellRenderer(params) {
			const renderedCell = renderItem(arr[params.index], params.index);
