...
const RoomEventQueue = function(){
	...
	_queue.process('subscribe',10, 'scripts/jobs/subscribe.js')
	_queue.process('unsubscribe',10, 'scripts/jobs/unsubscribe.js')
	_queue.process('checkTick',10, 'scripts/jobs/checkTick.js')
