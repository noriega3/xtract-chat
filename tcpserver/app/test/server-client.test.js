...
/*	const nodeServer = require('../pubsub_server.js')
	...
	createSocketTest('System Room Quick Test', './client-system-quick.test')
	createSocketTest('Standard Room Quick Test', './client-standard-quick.test')
	createSocketTest('Realtime Room Quick Test', './client-realtime-quick.test')
	createSocketTest('Turnbased Room Quick Test', './client-turnbased-quick.test')

	//full
	createSocketTest('System Room Full Test', './client-system-full.test')
