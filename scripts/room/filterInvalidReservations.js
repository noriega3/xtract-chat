...
const checkRoomSubscribeTypeReserves = store.getLua('./scripts/redis2/room/validators/checkRoomSubscribeTypeReserves.lua')
const checkRoomReservation = store.getLua('./scripts/redis2/room/validators/checkRoomReservation.lua')
