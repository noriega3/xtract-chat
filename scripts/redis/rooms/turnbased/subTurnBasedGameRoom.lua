...
--[[		TODO: this will be added to a network call
		...
		local gameId	= redis.call('hget', rk.roomInfo, 'gameId')
		local gameState = redis.call('hget', rk.roomInfo, 'gameState')
		local isActive 	= gameState and gameState == "ACTIVE" or gameState == "CREATED"

		--add them to opted in list
		gameId = isActive and gameId+1 or gameId
		rk.roomOptIns = rk.roomOptIns..gameId
