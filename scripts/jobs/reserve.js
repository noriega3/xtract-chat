...
const reserveOpenSeat = store.getLua("./scripts/redis2/room/updaters/reserveOpenSeat.lua")
const checkSessionState = store.getLua("./scripts/redis2/session/checkSessionState.lua")
const availableRoomsByPath = store.getLua("./scripts/redis2/room/collections/availableRoomsByPath.lua")
const checkReconnect = store.getLua("./scripts/redis2/room/validators/checkReconnect.lua")
const syncRoomCounts = store.getLua("./scripts/redis2/room/updaters/syncRoomCounts.lua")
const reserveNewRoomId = store.getLua("./scripts/redis2/room/updaters/reserveNewRoomId.lua")
...
module.exports = function(job){
	return withDatabase((db) => {
		...
		db.defineCommand('reserveNewRoomId', { numberOfKeys: 1, lua: reserveNewRoomId})
		db.defineCommand('reserveOpenSeat', { numberOfKeys: 3, lua: reserveOpenSeat})
		db.defineCommand('checkSessionState', { numberOfKeys: 2, lua: checkSessionState})
		db.defineCommand('checkReconnect', { numberOfKeys: 2, lua: checkReconnect})
		db.defineCommand('availableRoomsByPath', { numberOfKeys: 1, lua: availableRoomsByPath})
